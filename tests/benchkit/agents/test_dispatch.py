...
from agentcache.benchmarks.agents import AgentRunRequest, AgentRunResult
from agentcache.benchmarks.agents.dispatch import run_agent
...
def test_dispatches_claude_request(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr("agentcache.benchmarks.agents.dispatch.run_claude", fake_run_claude)
