...
def test_get_scheduler_cls_resolves_agent_scheduler():
    cfg = SchedulerConfig.default_factory(
        max_model_len=8192,
        scheduler_cls="agentinfer.agentcache.core.scheduler.AgentAwareScheduler",
    )
...
def test_patch_sets_scheduler_cls_when_none():
    ...
    assert args.scheduler_cls == "agentinfer.agentcache.core.scheduler.AgentAwareScheduler"
