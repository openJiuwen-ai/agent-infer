...
def schedule_batch(
    ...
    if high_kv_pressure and is_heterogeneous:
        ...
        # Age-weighted SRPT: priority = age_fraction × (min_len / prompt_len).
        # Short requests get lower latency (P50 win); age term prevents starvation.
        # A request's priority grows with time so long requests eventually compete.
        if waiting_requests:
